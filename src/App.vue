<template>  
  ...
  <p>Click the button when the block appears as fast as you can</p>
  <div class="buttons">
    <button @click="start" :disabled="isPlaying"><span></span><p data-start="good luck!" data-text="start!" data-title="new game"></p></button>
  </div>
...
.buttons button:disabled ::before, .buttons button:disabled ::after{
